...
export const defaultFAQ: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Да, платежи защищены банковским шифрованием. Мы не видим и не храним данные ваших карт.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Мы публикуем отчёты о тратах и мероприятиях на странице Отчётов. Там указаны суммы, даты и цели расходов.',
  },
  {
